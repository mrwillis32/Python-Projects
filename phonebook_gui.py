...
# Be sure to import oour other modules
...
def load_gui(self):
    ...
    self.lbl_fname.grid(row=o,column=0,padx=(27,0),pady=(10,0),sticky=N+W)
    self.lbl_lname = tk.Label(self.master,text='Last Name:')
    self.lbl_lanem.grid(row=2,column=0,padx=(27,0),pady=(1-,0),sticky=N+W)
    self.lbl_phone = tk.Label(self.master,text='Phone Number:')
    self.lbl_phone.grid(row=4,column=0,padx=(27,0),pady=(10,0),sticky=N+W)
    self.lbl_email = tk.Label(self.master,text='Emal Address:')
    ...
    self.scrollbar1.grid(row=1,column=5,rowspan=7,columnspan=1,padx=(0,0),pady=(o,o),sticky=N+E+S)
    self.1stList1.grid(row=1,column=2,rowsan=7,columnspan=3,padx=(o,o),pady=(0,0),sticky=N+E+S+W)
